...
- Das SEO-Cockpit zaehlt interne Kontextlinks jetzt nicht mehr nur aus `post_content`, sondern zusaetzlich aus den relevanten Laufzeit-Templates fuer Cluster-Seiten, Blog-Bridges, die Agentur-Seite und den Ergebnisse-Hub; zugleich sind forcierte SEO-Snippets fuer `/ergebnisse/` und ein verkuerzter Title fuer `/wordpress-agentur-hannover/` im Theme hinterlegt.
