...
$message_placeholder   = $is_general_type ? 'Worum geht es und welche Rückmeldung wäre hilfreich?' : ( $is_client_type ? 'Worum geht es gerade, was blockiert und was soll als Nächstes entschieden werden?' : ( 'pilot' === $selected_focus ? 'Welche Seite ist kritisch, woran scheitert sie aktuell und was soll sich nach dem Pilot verändern?' : 'Worum geht es im Projekt, was ist das Ziel und was soll sich konkret verbessern?' ) );
