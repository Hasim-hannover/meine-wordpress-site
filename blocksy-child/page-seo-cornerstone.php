...
<main id="main" class="site-main seo-cornerstone">

	<section class="nx-section seo-cornerstone__hero">
		<div class="nx-container">
			<span class="nx-badge nx-badge--gold">Cornerstone Artikel</span>
			<h1 class="seo-cornerstone__title">
	...
	<section class="nx-section">
		<div class="nx-container seo-cornerstone__layout">

				<aside class="seo-cornerstone__toc" aria-label="Inhaltsverzeichnis">
					<h2>Inhalt</h2>
					<ul>
						...
						<li><a href="#qualifizierung">Lead-Qualifizierung in der Praxis</a></li>
				...
				<article class="seo-cornerstone__content nx-prose">
					...
					<ul>
						...
						<li>starke Anzeigen auf schwachen Landingpages</li>
						<li>viel Reichweite, aber zu wenig <strong>Lead Qualifizierung</strong></li>
						<li>mehr Druck auf Vertrieb und Marketingbudget</li>
					</ul>
					<p>Deshalb geht es nicht um "SEO oder Ads". Es geht um <strong>Performance Marketing Synergie</strong>: Erst die Infrastruktur stabilisieren, dann Kampagnen effizient skalieren.</p>

					<h2 id="hausmodell">Das Haus-Modell: So wird Sichtbarkeit wirtschaftlich stabil</h2>
					<p>Denk Marketing als Haus, nicht als Kampagnenliste:</p>
					<ul>
						<li><strong>Fundament:</strong> Technisches SEO &amp; Tracking (Ladezeit, Mobile UX, saubere Datenbasis, klare Architektur)</li>
						<li><strong>Waende:</strong> CRO-Logik &amp; Seitenstruktur (Intent-Fit, Vertrauen, klare Nutzerpfade)</li>
						<li><strong>Dach:</strong> Performance Ads &amp; Kampagnen (Reichweite, Retargeting, Skalierung)</li>
					</ul>
					<p>Wer zuerst das Dach baut, bekommt kurzfristige Sichtbarkeit, aber keine Stabilitaet. Bei Wettbewerbsdruck oder Budgetschwankungen kippt das System.</p>

					<h2 id="mythos">Mythos vs. Realitaet: SEO ist Infrastruktur, keine Textkosmetik</h2>
					<p>Der groesste Denkfehler: SEO wird als redaktionelles Nebenthema eingeordnet. Auf Entscheider-Ebene ist das zu kurz gegriffen.</p>
					<p><strong>Mythos:</strong> SEO ist nur Keyword-Arbeit.<br>
					<strong>Realitaet:</strong> SEO verbindet Technik, UX, Analytics, Inhalte und Sales-Prozesse.</p>
					<p><strong>Mythos:</strong> SEO bringt nur Traffic.<br>
					<strong>Realitaet:</strong> Richtig umgesetzt steigert SEO die Qualitaet des gesamten Demand-Systems.</p>
					<p>Eine starke <strong>SEO Strategie Mittelstand</strong> beantwortet keine Vanity-Fragen, sondern Business-Fragen:</p>
					<ul>
					...
					<p>Google bewertet nicht nur Gebot und Anzeigentext, sondern auch die Landingpage-Erfahrung. Sind Seiten langsam, mobil unklar oder technisch inkonsistent, steigt der Preis pro wirksamen Klick.</p>
					<p>Bei schwachem Fundament passiert regelmaessig:</p>
					<ul>
						<li>Quality Score sinkt</li>
					...
					<p>Ein sauberes Setup verbindet SEO, CRO und Tracking zu einem Qualifizierungs-System:</p>
					<ul>
					...
					<ol>
						<li>Sind Conversion-Ziele technisch sauber messbar?</li>
						<li>Sind money pages mobil wirklich schnell?</li>
				...
				<details class="nx-faq__item">
					...
					<div class="nx-faq__content">Kurzfristig steigt Reichweite. Ohne stabiles Fundament steigen aber Streuverlust und Kosten oft schneller als Ergebnisqualitaet.</div>
				</details>
				<details class="nx-faq__item">
					<summary>Woran erkenne ich funktionierende Lead-Qualifizierung?</summary>
					<div class="nx-faq__content">Wenn weniger unpassende Erstgespraeche entstehen, Sales schneller priorisieren kann und die Abschlussquote trotz Wachstum stabil bleibt.</div>
				</details>
