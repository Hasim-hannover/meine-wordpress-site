...
function nexus_get_tools_hub_items() {
	...
	return [
		[
			...
			'outcome'      => 'Schriftliche Rueckmeldung in 48 Stunden mit staerkster Bremse, Prioritaet und naechstem sinnvollen Schritt.',
			'url'          => $audit_url,
		...
		[
			...
			'outcome'      => 'Ein klarer Ueberblick ueber Systemlogik, Proof, Module und den Audit-Einstieg.',
			'url'          => $wgos_url,
		...
		[
			...
			'use_case'     => 'Phasen, Module und konkrete Asset-Bausteine lesbar ueberblicken.',
			'outcome'      => 'Schneller Einstieg in die Arbeitslogik statt unverbundene Leistungslisten.',
			'url'          => $asset_hub_url,
			'cta_label'    => 'Systemlandkarte oeffnen',
			'schema_type'  => 'WebPage',
		],
		[
			'eyebrow'      => 'Performance',
			'title'        => 'Core Web Vitals',
			'description'  => 'Wenn Ladezeit, mobile Reibung und technische Stabilitaet zuerst als echter Nachfragefaktor eingeordnet werden sollen.',
