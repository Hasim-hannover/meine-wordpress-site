...
function nexus_get_llms_txt_content() {
	...
	$lines = [
		'# Haşim Üner',
		'',
		'> WordPress Growth Architect fuer B2B-Unternehmen in Hannover. Fokus: technische SEO, privacy-first Measurement, Core Web Vitals, Conversion-Architektur und das WordPress Growth Operating System (WGOS).',
		'',
		'## Primary Pages',
		'- [Startseite](' . ( $urls['home'] ?? home_url( '/' ) ) . '): Positionierung, Proof-Layer und Einstieg in das Nachfrage-System.',
		'- [WordPress Agentur Hannover](' . ( $urls['agentur'] ?? home_url( '/wordpress-agentur-hannover/' ) ) . '): Hauptseite fuer WordPress-Agentur-Intent in Hannover.',
		'- [Growth Audit](' . ( $urls['audit'] ?? home_url( '/growth-audit/' ) ) . '): diagnostischer Primaer-CTA fuer neue Projekte und Analysen.',
		'- [WGOS](' . ( $urls['wgos'] ?? home_url( '/wordpress-growth-operating-system/' ) ) . '): erklaert das WordPress Growth Operating System als verbindendes Modell.',
		'- [Ergebnisse](' . ( $urls['results'] ?? home_url( '/ergebnisse/' ) ) . '): oeffentliche Case Studies, Proof und Wirkung statt anonymer Testimonials.',
		'- [Ueber mich](' . ( $urls['about'] ?? home_url( '/uber-mich/' ) ) . '): Personenprofil, Arbeitsweise und fachlicher Kontext.',
		'',
		...
		'- [Core Web Vitals](' . ( $urls['cwv'] ?? home_url( '/core-web-vitals/' ) ) . '): Ladezeit, INP/LCP/CLS und technische Leistungsfaehigkeit auf kaufnahen Seiten.',
		'- [Conversion Rate Optimization](' . ( $urls['cro'] ?? home_url( '/conversion-rate-optimization/' ) ) . '): Angebotsseiten, CTA-Fuehrung, Proof und Reibungsabbau.',
