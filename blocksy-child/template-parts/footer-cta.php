 ...
 *   set_query_var( 'cta_text', 'Mein 360° Audit prüft Tech, SEO & Content.' );
...
$text        = get_query_var( 'cta_text', __( 'Ein Speed-Test reicht nicht. Mein 360° Audit prüft Tech, SEO & Content im Zusammenspiel.', 'blocksy-child' ) );
$url         = get_query_var( 'cta_url', home_url( '/customer-journey-audit/' ) );
$button_text = get_query_var( 'cta_button_text', __( 'Zum 360° Growth-Audit', 'blocksy-child' ) );
