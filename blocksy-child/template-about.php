...
<script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "Was kostet die Zusammenarbeit?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Das WGOS startet ab einem monatlichen Credit-Kontingent — kein Stundensatz, kein Projektvertrag. Der Einstieg ist kostenlos über den Free Journey Audit."
            }
        },
        {
            "@type": "Question",
            ...
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Zuerst der Free Journey Audit (48h, kostenlos, kein Pitch). Dann eine konkrete Prioritätenliste. Danach entscheiden Sie, ob und wie wir weiterarbeiten."
            }
        },
        {
            "@type": "Question",
            "name": "Wie lange bis zu ersten Ergebnissen?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Tracking und Performance sind in 4–6 Wochen sauber aufgesetzt. Erste organische Leads kamen bei E3 New Energy nach Woche 14. Die genaue Zeitlinie hängt von Ausgangslage und Branche ab."
            }
        },
        {
            "@type": "Question",
            "name": "Arbeiten Sie auch mit Paid Ads?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Ja — Paid Ads ergänzen das System dort, wo sie sich rechnen. Schwerpunkt liegt auf Owned Assets (SEO, CRO, Conversion-Architektur), weil diese langfristig günstiger sind."
            }
        },
        {
            "@type": "Question",
            "name": "Tracking und DSGVO — wie handhaben Sie das?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Server-Side GTM, Consent Mode v2, anonymisierte IPs — alles DSGVO-konform und vollständig dokumentiert. Das Setup gehört Ihnen, kein Blackbox-Tracking."
            }
        }
    ]
}
